...
export const LEROBOT_TRAINING_MODELS: TrainingModelOption[] = [
  ...
  },
  {
    ...
    value: "Pi0",
    description: {
      en: "Pi0 VLA policy option retained for LeRobot 0.6 training environments.",
      zh: "保留给 LeRobot 0.6 训练环境的 Pi0 VLA 策略选项。"
    },
    requiresTask: true,
    defaults: {
      learningRate: 0.0001,
  ...
  },
  {
    ...
    value: "Pi0.5",
    description: {
      en: "Pi0.5 lightweight fine-tuning preset using the base checkpoint and Action Expert scope by default.",
      zh: "Pi0.5 轻量微调预设，默认基于 base checkpoint 并只训练 Action Expert。"
    },
    requiresTask: true,
    defaults: {
  ...
  },
  {
    ...
    value: "SmolVLA",
    description: {
      en: "SmolVLA baseline for compact vision-language-action fine-tuning.",
      zh: "用于轻量视觉语言动作微调的 SmolVLA 基线。"
    },
    requiresTask: true,
    defaults: {
      learningRate: 0.0001,
